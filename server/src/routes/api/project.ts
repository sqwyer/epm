...
const APIProjectRouter = Router()

APIProjectRouter.post(
    "/:id/invite/send",
    protect,
                    ...
                    try {
                        ...
                        if (user) {
                            if (
                                ...
                                project.pending_members.push({
                                    id: user.id,
                                    role: new Types.ObjectId(req.body.role),
                                })
                                if (
                                    !user.pending_projects.includes(project._id)
                                )
